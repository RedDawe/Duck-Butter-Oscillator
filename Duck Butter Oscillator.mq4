//+------------------------------------------------------------------+
//|                                       Duck Butter Oscillator.mq4 |
//|                        Copyright 2020, MetaQuotes Software Corp. |
//|                                             https://www.mql5.com |
//+------------------------------------------------------------------+
#property description "Duck Butter Oscillator"
#property strict
...
double     ExtDnBuffer[];
//---
#define PERIOD_FAST  42
#define PERIOD_SLOW 69
//--- bars minimum for calculation
#define DATA_LIMIT  69
//+------------------------------------------------------------------+
...
//--- name for DataWindow and indicator subwindow label
   IndicatorShortName("Duck Butter Oscillator");
